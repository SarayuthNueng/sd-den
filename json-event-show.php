...
<div class="modal modal-tour position-static d-block  py-5" tabindex="-1" role="dialog" id="modalTour">
		...
		<h2 class="text-center fw-bold mb-0">ข้อมูลการนัด</h2>
			<ul class="mt-3 d-grid gap-4  list-unstyled">
			<li class="d-flex gap-4 py-3">
			<img
            ...
            />
			<div class="px-4">
				<h5 class="mb-0">เบอร์โทรศัพท์คนไข้</h5>
            ...
            />
			<div class="px-4">
				<h5 class="mb-0">ประเภทหัตถการ</h5>
				' . $get_data['color'] . '
			</div>
			<li class="d-flex gap-4 py-3">
			<img
            ...
            />
			<div class="px-4">
				<h5 class="mb-0">วันที่และเวลาที่เริ่ม</h5>
				' . $get_data['start'] . '
			</div>
			<li class="d-flex gap-4 py-3">
			<img
            ...
            />
			<div class="px-4">
				<h5 class="mb-0">วันที่และเวลาที่สิ้นสุด</h5>
				' . $get_data['end'] . '
			</div>
			</li>
			</ul>
			<button type="button" class="text-center btn btn-lg btn-danger mt-5 w-100" data-dismiss="modal">ปิด</button>
		</div>
		</div>
		</div>
		</div>
