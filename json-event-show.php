...
<div class="container">
	...
	<h6 class="mt-3"><i class="fa-solid fa-hospital-user" style="color:#BF7FFF; margin-right: 10px;"></i>    ชื่อคนไข้ : </h6>
	<h6 class="mt-3"><i class="fa-solid fa-phone" style="color:#BF7FFF; margin-right: 10px;"></i>    เบอร์โทรศัพท์คนไข้ : </h6>
	<h6 class="mt-3"><i class="fa-solid fa-tooth" style="color:#BF7FFF; margin-right: 10px;"></i>    ประเภทหัตถการ : </h6>
