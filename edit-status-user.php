									...
									<div class="row formtype">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="title" value="<?= $row['title']; ?>" minlength="3" disabled="disabled">
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="procedure_name" value="<?= $row['procedure_name']; ?>" minlength="3" disabled="disabled">
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="patient_name" value="<?= $row['pname_patient']; ?><?= $row['patient_name']; ?>" disabled="disabled">
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="patient_tel" value="<?= $row['patient_tel']; ?>" minlength="3" disabled="disabled">
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="datetime-local" name="start" value="<?= $row['start']; ?>" minlength="3" >
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="datetime-local" name="end" value="<?= $row['end']; ?>" minlength="3" >
											</div>
										</div>
