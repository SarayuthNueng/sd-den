...
if (!$_SESSION["user_id"]) {  //check session
			...
			<div class="content container-fluid mt-5">
				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12">
								<?php if (isset($_SESSION['check_cid'])) : ?>
									<div class="alert alert-danger alert-custom" role="alert">
										<?php echo $_SESSION['check_cid']; ?>
									</div>
								<?php endif; ?>
									...
									<div class="row formtype">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="password" name="confirm_password" placeholder="ยืนยันรหัสผ่าน" required>
											</div>
										</div>
										<div class="col-md-4">
											<label>ชื่อ</label>
										...
										<div class="col-md-4">
											<div class="form-group">
												<label>ที่อยู่</label>
												<textarea class="form-control" type="text" name="address" placeholder="ที่อยู่" id="exampleFormControlTextarea1" rows="2" required></textarea>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>เบอร์โทรศัพท์</label>
												<input class="form-control" type="tel" name="tel" placeholder="เบอร์โทรศัพท์" required>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
	...
	<?php
	if (isset($_SESSION['check_cid']) || isset($_SESSION['err_pw']) || isset($_SESSION['exist_uname']) || isset($_SESSION['err_cid'])) {
		unset($_SESSION['check_cid']);
