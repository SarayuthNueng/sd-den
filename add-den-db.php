<?php
 //ถ้ามีค่าส่งมาจากฟอร์ม
    ...
    $role = $_POST['role'];
    //sql insert
    $stmt = $conn->prepare("INSERT INTO member (fname, lname, cid, username, password, address, tel, email, date, role)
    VALUES (:fname, :lname, :cid, :username, :password, :address, :tel, :email, :date, :role)");
