...
$user_level = $_POST['user_level'];
  ...
  if(mysqli_num_rows($result_cid) > 0 ){
    ...
    header('location: ../edit-den.php?user_id='.$user_id.'');
    ...
    // ทำการแก้ไขข้อมูล
                ...
                $result_edit = mysqli_query($conn, $den_edit);
                ...
                echo '<script>
                        ...
                        swal({
                            ...
                            window.location = "../edit-den.php?user_id='.$user_id.'"; //หน้าที่ต้องการให้กระโดดไป
                        });
                        }, 1000);
                    </script>';
                }
