...
if (isset($_POST['title']) && isset($_POST['more']) && isset($_POST['start']) && isset($_POST['end']) && isset($_POST['color']) && isset($_POST['pname_patient']) && isset($_POST['patient_name']) && isset($_POST['patient_tel'])) {
	...
	$sql = "INSERT INTO calendar(title, more, start, end, color, pname_patient, patient_name, patient_tel, cid, status) values ('$title', '$more', '$start', '$end', '$color', '$pname_patient', '$patient_name', '$patient_tel', '$cid', 'อนุมัติ')";
	echo $sql;
