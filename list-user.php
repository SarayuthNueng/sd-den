											...
											<tbody>
												<tr>
													...
													?>
														...
														<td><?= $k['username']; ?></td>
														<td>
															<a type="button" style="color: steelblue; font-weight: bold;" href="edit-password-user.php?user_id=<?= $k['user_id']; ?>">
																แก้ไขรหัสผ่าน
															</a>
														</td>
														<td><?= $k['pname'] ?></td>
														...
														<td><?= $k['user_level']; ?></td>
														<td>
															<a type="button" class="fas fa-edit ml-2" href="edit-user.php?user_id=<?= $k['user_id']; ?>" role="button" style="color:steelblue;">
															</a>
														</td>
														<td>
