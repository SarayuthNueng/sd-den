		...
		<div class="content container-fluid">
			<div class="page-header ">
				...
				<div class="row formtype mt-5">
					...
					<div class="col-3">
						<a type="button" style="color: lemonchiffon;float: right;background: goldenrod; border-color: goldenrod;" class="btn " href="add-procedure.php" role="button">+ เพิ่มรายการหัตถการ</a>
					</div>
				</div>
			</div>
			<div class="row">
									...
									<tbody>
										<tr>
											...
											?>
												...
												<td>
													<a type="button" class="fas fa-edit ml-2" href="edit-procedure.php?procedure_id=<?= $p['procedure_id']; ?>" role="button" style="color:steelblue;">
													</a>
												</td>
												<td>
													<a type="button" class="fa fa-trash ml-2 " aria-hidden="true" onclick="return confirm('ยืนยันการลบข้อมูล !!');" href="function/del-procedure.php?procedure_id=<?= $p['procedure_id']; ?>" role="button" style="color:tomato">
													</a>
												</td>
