!(function (t) {
  ...
  function g(t) {
    ...
    return (
      ...
      v() && "rtl" == t.css("direction") ? (e.left = n) : (e.right = n),
      e
    );
  }
  function p(t) {
  ...
  function L(t, e) {
    ...
    for (
      n = 0;
      n < qt.length && ((i = qt[n]), !((r = N(i, t, e)) >= 1 && rt(r)));
      n++
    );
    return i;
  }
  ...
  function V(t, e) {
    ...
    return G(t) || G(e)
      ...
      : ((n = t.asMonths()),
        (i = e.asMonths()),
        Math.abs(n) >= 1 && rt(n) && Math.abs(i) >= 1 && rt(i)
          ? n / i
          : t.asDays() / e.asDays());
  }
  function G(t) {
  ...
  function ct(t, e) {
    var n;
    return (
      Y(e, "constructor") && (n = e.constructor),
      "function" != typeof n &&
        (n = e.constructor =
          function () {
  ...
  function ft(t, e) {
    return (
      (!t && !e) ||
      (!(!t || !e) && t.component === e.component && gt(t, e) && gt(e, t))
    );
  }
  function gt(t, e) {
    for (var n in t)
  ...
  function vt(n) {
    ...
    return (
      ...
      (i = n.data(a + "event") || null) &&
        (null ==
          (r = (i = "object" == typeof i ? t.extend({}, i) : {}).start) &&
          (r = i.time),
        (s = i.duration),
        (o = i.stick),
        delete i.start,
  ...
  function yt(e, n) {
        ...
        o &&
          t.each(o.split(" "), function (n) {
            ...
            t.each(this.split(","), function (n, i) {
              ...
              "title" == i
                ...
                : ((s = l[i])
                    ? ((f = function (t) {
                      ...
                      (g = r.getCustomButtonIconClass(s)) ||
                        (g = r.getIconClass(i)) ||
                        (p = s.text))
                    : (d = e.getViewSpec(i))
                    ? (a.push(i),
                      ...
                      (p = d.buttonTextOverride) ||
                        (g = r.getIconClass(i)) ||
                        (p = d.buttonTextDefault))
                    : e[i] &&
                      ((f = function () {
                        e[i]();
                      }),
                      (p = u[i]) || (g = r.getIconClass(i)) || (p = c[i])),
                  f &&
                    ((m = [
                      "fc-" + i + "-button",
                      r.getClass("button"),
              ...
              o.length > 1
                ? ((i = t("<div/>")),
                  h && i.addClass(r.getClass("buttonGroup")),
                  i.append(o),
                  s.append(i))
                : s.append(o);
          }),
    ...
    (s.setToolbarOptions = function (t) {
      ...
      (s.removeElement = i),
      (s.updateTitle = function (e) {
        if (o) {
          for (
            var n = t.trim(e).split(" "), i = n.length, r = "", s = 0;
            s < i;
            s++
          )
            r += i - 1 == s ? parseInt(n[s]) + 543 : n[s] + " ";
          o.find("h2").text(r);
        }
      }),
  ...
  function Ct(t, e) {
    var n,
      ...
      r = [],
      s = e.startMs;
    for (t.sort(Rt), n = 0; n < t.length; n++)
      (i = t[n]).startMs > s && r.push(new Oe(s, i.startMs)),
        i.endMs > s && (s = i.endMs);
  ...
  function Mt(t) {
    return new Ke(
      new Ne(t.unzonedRange, t.eventDef.isAllDay()),
      t.eventDef,
      t.eventInstance
    );
  }
  ...
  function At(t) {
    ...
    if (void 0 === t.forwardPressure) {
      for (e = 0; e < i.length; e++)
        At((n = i[e])), (r = Math.max(r, 1 + n.forwardPressure));
      t.forwardPressure = r;
    }
  }
  function Lt(t, e, n) {
  ...
  var Vt = (t.fullCalendar = { version: "3.6.2", internalApiVersion: 11 }),
    Gt = (Vt.views = {});
    ...
    return (
      this.each(function (r, s) {
        ...
        "string" == typeof e
          ...
          : l || ((l = new Fe(a, e)), a.data("fullCalendar", l), l.render());
      }),
      i
    );
  };
  ...
  (Vt.applyAll = j),
    ...
    (Vt.cssToStr = tt),
    (Vt.proxy = st),
    (Vt.capitaliseFirstLetter = nt),
    (Vt.getOuterRect = d),
    (Vt.getClientRect = f),
    (Vt.getContentRect = function (t, e) {
      var n = t.offset(),
        i =
          n.left +
  ...
  (Vt.preventDefault = R),
    (Vt.intersectRects = T),
    (Vt.parseFieldSpecs = x),
    (Vt.compareByFieldSpecs = P),
    (Vt.compareByFieldSpec = z),
    (Vt.flexibleCompare = F),
    (Vt.computeGreatestUnit = L),
    (Vt.divideRangeByDuration = function (t, e, n) {
      var i;
      return G(n)
        ? (e - t) / n
        : ((i = n.asMonths()),
    ...
    (Vt.divideDurationByDuration = V),
    (Vt.multiplyDuration = function (t, n) {
      var i;
      return G(t)
        ? e.duration(t * n)
        : ((i = t.asMonths()),
  ...
  Xt.push("_fullCalendar"),
    ...
    (Qt.format = function () {
      return this._fullCalendar && arguments[0]
        ? Kt(this, arguments[0])
        : this._ambigTime
        ? te(lt(this), "YYYY-MM-DD")
        : this._ambigZone
        ? te(lt(this), "YYYY-MM-DD[T]HH:mm:ss")
        : this._fullCalendar
        ? te(lt(this))
    ...
    (Qt.toISOString = function () {
      return this._ambigTime
        ...
        ? te(lt(this), "YYYY-MM-DD[T]HH:mm:ss")
        : this._fullCalendar
        ? $t.toISOString.apply(lt(this), arguments)
    ...
    (function () {
      ...
      function e(t, e, n, i, r) {
        var s,
          ...
          y = "",
          w = "";
        for (s = 0; s < l.length && (!l[s] || h.isSame(d, l[s])); s++)
          p += f[s];
        for (
          o = l.length - 1;
          o > s &&
      ...
      function a(t) {
        ...
        for (e = 0; e < t.length; e++)
          (n = t[e]).token
            ? ((i = v[n.token.charAt(0)]), r.push(i ? i.unit : "second"))
            : n.maybe
            ? r.push.apply(r, a(n.maybe))
            : r.push(null);
        return r;
      }
      function l(t, e) {
      ...
      function u(e, n) {
        ...
        for (i = 0; i < o.length; i++)
          (r = o[i]).charAt(0) === d ? s.push(p[r.substring(1)](n)) : s.push(r);
        return s;
      }
      function c(t) {
      ...
      (Vt.formatDate = function (t, e) {
        ...
        (Vt.formatRange = function (t, i, r, s, o) {
          ...
          return (
            ...
            (i = Vt.moment.parseZone(i)),
            (a = t.localeData()),
            (r = a.longDateFormat(r) || r),
            e(n(r), t, i, s || " - ", o)
          );
        }),
        (Vt.oldMomentFormat = t),
        (Vt.queryMostGranularFormatUnit = function (t) {
          var e,
            n,
            i,
            s,
  ...
  var ue = ut.extend(ne, {
    ...
    ce = (Vt.CoordCache = ut.extend({
      ...
      queryBoundingRect: function () {
        var t;
        return this.els.length > 0 && !(t = h(this.els.eq(0))).is(document)
          ? f(t)
          : null;
      },
    ...
    he = (Vt.DragListener = ut.extend(ne, {
      options: null,
      subjectEl: null,
      originX: null,
      originY: null,
      ...
      startInteraction: function (e, n) {
        ...
        this.isInteracting ||
          ((n = n || {}),
          (this.delay = X(n.delay, this.options.delay, 0)),
          (this.minDistance = X(n.distance, this.options.distance, 0)),
  ...
  he.mixin({
    ...
    initAutoScroll: function () {
      ...
      (this.isAutoScroll =
        ...
        this.isAutoScroll &&
          this.listenTo(t, "scroll", ot(this.handleDebouncedScroll, 100));
    },
  ...
  var de = he.extend({
    ...
    handleInteractionStart: function (t) {
      ...
      this.component.hitsNeeded(),
        ...
        t
          ? ((i = n = { left: D(t), top: b(t) }),
            r && (i = I(i, (e = d(r)))),
            (this.origHit = this.queryHit(i.left, i.top)),
            r &&
              this.options.subjectCenter &&
              (this.origHit && (e = T(this.origHit, e) || e), (i = H(e))),
            (this.coordAdjust = M(i, n)))
    ...
    handleDragStart: function (t) {
      ...
      he.prototype.handleDragStart.apply(this, arguments),
        (e = this.queryHit(D(t), b(t))) && this.handleHitOver(e);
    },
    handleDrag: function (t, e, n) {
      var i;
      he.prototype.handleDrag.apply(this, arguments),
        ft((i = this.queryHit(D(n), b(n))), this.hit) ||
  ...
  var ve = ut.extend({
    ...
    we = (Vt.EventDragging = ve.extend({
      ...
      buildSelectListener: function (t) {
        ...
        var s = (this.dragListener = new he({
          dragStart: function (t) {
            s.isTouch &&
      ...
      buildDragListener: function (t) {
        ...
        if (this.dragListener) return this.dragListener;
        var g = (this.dragListener = new de(l, {
          scroll: this.opt("dragScroll"),
          subjectEl: h,
          subjectCenter: !0,
          ...
          hitOver: function (e, o, h) {
            ...
            t.hit && (h = t.hit),
              ...
              f && p && (i = r.computeEventDropMutation(f, p, d))
    ...
    De = (Vt.EventResizing = ve.extend({
      ...
      buildDragListener: function (t, e) {
        var n,
          ...
          d = t.footprint.eventDef,
          f = t.footprint.eventInstance;
        return (this.dragListener = new de(a, {
          scroll: this.opt("dragScroll"),
          subjectEl: h,
          interactionStart: function () {
            n = !1;
      ...
      computeEventStartResizeMutation: function (t, e, n) {
        ...
        return (
          ...
          ((i = new tn()).setStartDelta(o),
          (r = new Je()).setDateMutation(i),
          r)
        );
      },
      computeEventEndResizeMutation: function (t, e, n) {
        ...
        return (
          ...
          ((i = new tn()).setEndDelta(o), (r = new Je()).setDateMutation(i), r)
        );
      },
    })),
    be = (Vt.ExternalDropping = ve.extend(ne, {
      ...
      listenToExternalDrag: function (t, e, n) {
        ...
        (r.dragListener = new de(a, {
          ...
          hitOver: function (t) {
            ...
            o && (i = r.computeExternalDrop(o, u))
              ? ((e = new Qe(i.buildInstances())),
                (n = u.eventProps
      ...
      computeExternalDrop: function (e, n) {
        ...
        return (
          ...
          Ye.parse(t.extend({}, n.eventProps, { start: s, end: i }), new en(r))
        );
      },
    }));
  Vt.dataAttrPrefix = "";
        ...
        if (n.length) {
          ...
          t(o).each(function (e, r) {
            ...
            i.filterEl && (l = i.filterEl(o, l)),
              l && (l = t(l)).is(s.fillSegTag) && ((o.el = l), a.push(o));
          });
        }
        return a;
      },
    ...
    Me = (Vt.DateComponent = He.extend({
      ...
      executeEventRender: function (t) {
        this.eventRenderer
          ...
          : this.renderEvents && this.renderEvents(mt(t)),
  ...
  (Me.guid = 0),
    Me.mixin({
      ...
      formatRange: function (t, e, n, i) {
        var r = t.end;
        return (
          e && (r = r.clone().subtract(1)), Jt(t.start, r, n, i, this.isRTL)
        );
      },
  ...
  var xe = (Vt.InteractiveDateComponent = Me.extend({
      ...
      setElement: function (t) {
        Me.prototype.setElement.apply(this, arguments),
      ...
      executeEventUnrender: function () {
        this.endInteractions(),
          Me.prototype.executeEventUnrender.apply(this, arguments);
      },
      bindGlobalHandlers: function () {
        Me.prototype.bindGlobalHandlers.apply(this, arguments),
          this.externalDropping && this.externalDropping.bindToDocument();
      },
      unbindGlobalHandlers: function () {
        Me.prototype.unbindGlobalHandlers.apply(this, arguments),
      ...
      diffDates: function (t, e) {
        return this.largeUnit ? A(t, e, this.largeUnit) : k(t, e);
      },
    ...
    ze = (Vt.View = xe.extend({
      ...
      constructor: function (t, e) {
        (this.calendar = t),
          ...
          (this.eventOrderSpecs = x(this.opt("eventOrder"))),
      ...
      initRenderQueue: function () {
        (this.renderQueue = new le({ event: this.opt("eventRenderWait") })),
      ...
      executeDateRender: function (t) {
        Me.prototype.executeDateRender.apply(this, arguments),
      ...
      executeDateUnrender: function () {
        this.unselect(),
          ...
          Me.prototype.executeDateUnrender.apply(this, arguments);
      },
      ...
      bindGlobalHandlers: function () {
        xe.prototype.bindGlobalHandlers.apply(this, arguments),
          this.listenTo(fe.get(), {
            touchstart: this.processUnselect,
            mousedown: this.handleDocumentMousedown,
          });
      },
      unbindGlobalHandlers: function () {
        xe.prototype.unbindGlobalHandlers.apply(this, arguments),
          this.stopListeningTo(fe.get());
      },
      ...
      updateSize: function (t, e, n) {
        this.setHeight
          ? this.setHeight(t, e)
          : xe.prototype.updateSize.apply(this, arguments),
      ...
      reportEventDrop: function (t, n, i, r) {
        var s = this.calendar.eventManager.mutateEventsWithId(
          ...
          o = n.dateMutation;
        o &&
          (t.dateProfile = o.buildNewDateProfile(t.dateProfile, this.calendar)),
          this.triggerEventDrop(t, (o && o.dateDelta) || e.duration(), s, i, r);
      },
      ...
      renderSelectionFootprint: function (t, e) {
        this.renderSelection
          ...
          : xe.prototype.renderSelectionFootprint.apply(this, arguments);
      },
    ...
    ze.mixin({
      ...
      buildDateProfile: function (t, n, i) {
        ...
        return (
          ...
          (l = l.intersect(r)) &&
            (t = this.calendar.msToUtcMoment(l.constrainDate(t), c)),
      ...
      buildCurrentRangeInfo: function (t, e) {
        ...
        return (
          this.viewSpec.duration
            ...
            ? (r = L(s.getStart(), s.getEnd()))
            : ((r = L((i = this.getFallbackDuration()))),
              (s = this.buildRangeFromDuration(t, e, i, r))),
      ...
      buildRangeFromDuration: function (t, n, i, r) {
        ...
        return (
          i.as("days") <= 1 &&
            this.isHiddenDay(u) &&
            (u = this.skipHiddenDays(u, n)).startOf("day"),
          l ||
            (l =
              (o = this.opt("dateIncrement")) && (a = e.duration(o)) < i
                ? O(a, o)
                : r),
          u.startOf(l),
          (s = u.clone().add(i)),
      ...
      buildRangeFromDayCount: function (t, e, n) {
        ...
        r && o.startOf(r),
          o.startOf("day"),
          (i = (o = this.skipHiddenDays(o, e)).clone());
        do {
  ...
  var Fe = (Vt.Calendar = ut.extend(ee, ne, {
    ...
    parseUnzonedRange: function (t) {
      ...
      return (
        ...
        e || n ? (e && n && n.isBefore(e) ? null : new Oe(e, n)) : null
      );
    },
  ...
  Fe.mixin({
    ...
    populateOptionsHash: function () {
      var t, e, i, r;
      (t = X(this.dynamicOverrides.locale, this.overrides.locale)),
        (e = ke[t]) || ((t = Fe.defaults.locale), (e = ke[t] || {})),
        (i = X(
        ...
        Et((r = n([Fe.defaults, i, e, this.overrides, this.dynamicOverrides]))),
          ...
          this.optionsModel.watch(
            ...
            function (e) {
              ...
              e.monthNames && (s._months = e.monthNames),
                ...
                null == r && "ISO" === i && (r = 1),
                null != r &&
                  (((n = Object.create(s._week)).dow = r), (s._week = n)),
      ...
      moment: function () {
        ...
        return (
          "local" === this.opt("timezone")
            ? (t = Vt.moment.apply(null, arguments)).hasTime() && t.local()
            : (t =
      ...
      initialRender: function () {
        ...
        n.addClass("fc"),
          n.on("click.fc", "a[data-goto]", function (n) {
            ...
            "function" == typeof o
              ? o(r, n)
              : ("string" == typeof o && (s = o), e.zoomTo(r, s));
          }),
          this.optionsModel.watch(
            "settingTheme",
            ["?theme", "?themeSystem"],
            function (t) {
              var i = new (an.getThemeClass(t.themeSystem || t.theme))(
                  e.optionsModel
                ),
                r = i.getClass("widget");
          ...
          this.optionsModel.watch(
            ...
            ["?businessHours"],
            function (t) {
              (e.businessHourGenerator = new We(t.businessHours, e)),
                e.view &&
    ...
    Fe.mixin({
      ...
      initToolbars: function () {
        (this.header = new yt(this, this.computeHeaderOptions())),
          (this.footer = new yt(this, this.computeFooterOptions())),
          (this.toolbarsManager = new pt([this.header, this.footer]));
      },
    ...
    (Fe.prototype.isEventInstanceGroupAllowed = function (t) {
      ...
      if (l)
        for (e = 0; e < i.length; e++)
          if (
            !1 ===
            l(i[e].componentFootprint.toLegacy(this), i[e].getEventLegacy())
          )
            return !1;
      return !0;
    }),
    ...
    (Fe.prototype.isSelectionFootprintAllowed = function (t) {
      var e,
        n = this.eventManager.getEventInstances().map(Ht),
    ...
    (Fe.prototype.parseFootprints = function (t) {
      var e, n;
      return (
        t.start && ((e = this.moment(t.start)).isValid() || (e = null)),
        t.end && ((n = this.moment(t.end)).isValid() || (n = null)),
        [new Ne(new Oe(e, n), (e && !e.hasTime()) || (n && !n.hasTime()))]
      );
    }),
    ...
    Fe.mixin({
      ...
      renderEvent: function (t, e) {
        var n = this.eventManager,
          i = _e.parse(t, t.source || n.stickySource);
        i && n.addEventDef(i, e);
      },
      ...
      updateEvent: function (t) {
        ...
        i instanceof Ye &&
          ((e = i.buildInstance()),
          (n = Je.createFromRawProps(e, t, null)),
  ...
  var Oe = (Vt.UnzonedRange = ut.extend({
      ...
      intersect: function (t) {
        ...
        return (
          ...
          (null === e || null === n || e < n) &&
            (((i = new Oe(e, n)).isStart = this.isStart && e === this.startMs),
    ...
    Ve = ut.extend(ee, {
      ...
      removeEventInstancesForDef: function (t) {
        var e,
          ...
          i = n[t.id];
        i &&
          ((e = Z(i.eventInstances, function (e) {
            return e.def === t;
          })),
      ...
      whenReleased: function () {
        ...
        return this.releaseCnt
          ? oe.resolve(this.eventInstanceGroupsById)
          : oe.construct(function (e) {
              t.one("release", e);
            });
      },
      freeze: function () {
    ...
    Ge = ut.extend(ee, ne, {
      ...
      querySources: function (e) {
        ...
        return (i = this.getSourceById(en.normalizeId(e)))
          ? [i]
          : ((e = nn.parse(e, this.calendar)),
            e
              ? t.grep(r, function (t) {
                  return Tt(e, t);
                })
  ...
  var Ue = {
    ...
    We = (Vt.BusinessHourGenerator = ut.extend({
      rawComplexDef: null,
      calendar: null,
      constructor: function (t, e) {
      ...
      buildEventInstanceGroup: function (t, e) {
        ...
        if (i.length)
          return (n = new Qe(It(i, e))), (n.explicitEventDef = i[0]), n;
      },
      ...
      buildEventDef: function (e, n) {
        ...
        return (
          ...
          je.parse(i, new en(this.calendar))
        );
      },
    })),
    _e = {
  ...
  (qe.defineStandardProps = re),
    (qe.copyVerbatimStandardProps = function (t, e) {
      var n,
  ...
  Ye.defineStandardProps({ start: !1, date: !1, end: !1, allDay: !1 });
  var je = qe.extend({
    startTime: null,
    endTime: null,
    dowHash: null,
  ...
  je.defineStandardProps({ start: !1, end: !1, dow: !1 });
  var Ze = ut.extend({
      def: null,
      dateProfile: null,
      constructor: function (t, e) {
      ...
      mutateSingle: function (t) {
        ...
        return (
          ...
          this.verbatimStandardProps &&
            Ye.copyVerbatimStandardProps(this.verbatimStandardProps, t),
  ...
  Je.createFromRawProps = function (t, e, n) {
    ...
    return (
      (r = $e.parse(l, a.source)) &&
        (s = tn.createFromDiff(t.dateProfile, r, n)),
      u.id !== a.id && (d = u.id),
      $(u.className, a.className) || (f = u.className),
  ...
  tn.createFromDiff = function (t, e, n) {
    function i(t, i) {
      return n ? A(t, i, n) : e.isAllDay() ? B(t, i) : k(t, i);
    }
    var r,
      s,
      o,
    ...
    return (
      (r = i(e.start, t.start)),
      e.end &&
        (s = i(e.unzonedRange.getEnd(), t.unzonedRange.getEnd()).subtract(r)),
      (o = new tn()),
      (o.clearEnd = a),
      (o.forceTimed = l),
      (o.forceAllDay = u),
  ...
  var en = ut.extend(ie, {
    ...
    parseEventDef: function (t) {
      ...
      return e && (t = e(t)), n && (t = n(t)), _e.parse(t, this);
    },
    applyManualStandardProps: function (e) {
      return (
        null != e.id && (this.id = en.normalizeId(e.id)),
  ...
  (en.defineStandardProps = re),
    (en.uuid = 0),
    (en.normalizeId = function (t) {
  ...
  var rn = en.extend({
    ...
    fetch: function (t, e, n) {
      ...
      if (null !== this.currentTimezone && this.currentTimezone !== n)
        for (i = 0; i < r.length; i++) r[i] instanceof Ye && r[i].rezone();
  ...
  rn.defineStandardProps({ events: !1 }),
  ...
  sn.defineStandardProps({ events: !1 }),
  ...
  var on = en.extend({
    ...
    fetch: function (e, n, i) {
      ...
      return (
        this.calendar.pushLoading(),
        oe.construct(function (e, n) {
          t.ajax(
            t.extend({}, on.AJAX_DEFAULTS, s, {
              url: r.url,
              data: l,
              success: function (i) {
                var s;
                r.calendar.popLoading(),
                  i
                    ? ((s = j(o, this, arguments)),
                      t.isArray(s) && (i = s),
                      e(r.parseEventDefs(i)))
                    : n();
              },
              error: function () {
                r.calendar.popLoading(), j(a, this, arguments), n();
              },
            })
          );
        })
    ...
    buildRequestParams: function (e, n, i) {
      var r,
        ...
        c = {};
      return (
        null == (r = this.startParam) && (r = l.opt("startParam")),
        null == (s = this.endParam) && (s = l.opt("endParam")),
        null == (o = this.timezoneParam) && (o = l.opt("timezoneParam")),
    ...
    applyMiscProps: function (t) {
      en.prototype.applyMiscProps.apply(this, arguments),
        (this.ajaxSettings = t);
    },
  });
  (on.AJAX_DEFAULTS = { dataType: "json", cache: !1 }),
  ...
  var dn = Te.extend({
      ...
      renderSegs: function (e, n) {
        ...
        return (
          ...
          this.component.rowEls.each(function (e, s) {
            ...
            n && n.row === e
              ? (a = n.el.position().top)
              : ((o = l.find(".fc-content-skeleton tbody")).length ||
                  (o = l.find(".fc-content-skeleton table")),
                (a = o.position().top)),
    ...
    pn = (Vt.DayGrid = xe.extend(Se, Pe, {
      ...
      unrenderEvents: function () {
        this.removeSegPopover(),
          xe.prototype.unrenderEvents.apply(this, arguments);
      },
      getOwnEventSegs: function () {
        return xe.prototype.getOwnEventSegs
  ...
  pn.mixin({
    ...
    computeRowLevelLimit: function (e) {
      ...
      for (n = 0; n < o.length; n++)
        if (
          ((i = o.eq(n).removeClass("fc-limited")),
          (r = 0),
          i.find("> td > :first-child").each(function (e, n) {
    ...
    limitRow: function (e, n) {
      ...
      if (n && n < D.segLevels.length) {
        for (
          ...
          for (i((l = r[a]).leftCol), h = [], c = 0; E <= l.rightCol; )
            (u = this.getCellSegs(e, E, n)), h.push(u), (c += u.length), E++;
          if (c) {
            for (
              f = (d = s[n - 1][l.leftCol]).attr("rowspan") || 1, g = [], p = 0;
              p < h.length;
              p++
            )
    ...
    resliceDaySegs: function (e, n) {
      var i,
        ...
        u = [];
      for (i = 0; i < e.length; i++)
        (s = (r = e[i]).footprint.componentFootprint.unzonedRange.intersect(
          l
        )) &&
          u.push(
            t.extend({}, r, {
              footprint: new Ke(
                new Ne(s, r.footprint.componentFootprint.isAllDay),
  ...
  var vn = (Vt.BasicView = ze.extend({
      ...
      constructor: function () {
        ze.apply(this, arguments),
          ...
          (this.scroller = new pe({ overflowX: "hidden", overflowY: "auto" }));
      },
      ...
      executeDateRender: function (t) {
        (this.dayGrid.breakOnWeeks = /year|month|week/.test(
          ...
          ze.prototype.executeDateRender.apply(this, arguments);
      },
      renderSkeleton: function () {
        var e, n;
      ...
      updateSize: function (t, e, n) {
        ...
        this.dayGrid.rowEls
          ? (ze.prototype.updateSize.apply(this, arguments),
    ...
    mn = {
      ...
      getIsNumbersVisible: function () {
        return (
          pn.prototype.getIsNumbersVisible.apply(this, arguments) ||
    ...
    yn = (Vt.MonthView = vn.extend({
      buildRenderRange: function (t, e, n) {
        var i,
          r = vn.prototype.buildRenderRange.apply(this, arguments),
  ...
  (Gt.basic = { class: vn }),
    (Gt.basicDay = { type: "basic", duration: { days: 1 } }),
    (Gt.basicWeek = { type: "basic", duration: { weeks: 1 } }),
    (Gt.month = {
      class: yn,
      duration: { months: 1 },
  ...
  var wn = Te.extend({
    ...
    Dn = Ce.extend({
        ...
        return (
          ...
          (n
            ? '<div class="fc-time" data-start="' +
              ...
              "</span></div>"
            : "") +
          (u.title ? '<div class="fc-title">' + K(u.title) + "</div>" : "") +
          '</div><div class="fc-bg"/>' +
      ...
      computeFgSegHorizontals: function (t) {
        var e, n, i;
        if ((this.sortEventSegs(t), (e = kt(t)), Bt(e), (n = e[0]))) {
    ...
    En = (Vt.TimeGrid = xe.extend(Se, Pe, {
      ...
      computeLabelInterval: function (t) {
        ...
        for (n = In.length - 1; n >= 0; n--)
          if (((i = e.duration(In[n])), (r = V(i, t)), rt(r) && r > 1))
            return i;
        return e.duration(t);
      },
      renderDates: function (t) {
        ...
        for (
          ...
          (t = s.msToUtcMoment(l.renderUnzonedRange.startMs).time(c)),
            ...
            (i =
              ...
              r.axisStyleAttr() +
              ">" +
              (n ? "<span>" + K(t.format(this.labelFormat)) + "</span>" : "") +
              "</td>"),
            (u +=
              '<tr data-time="' +
              t.format("HH:mm:ss") +
      ...
      updateSize: function (t, e, n) {
        ...
        if (
          ...
          this.timeGrid.bottomRuleEl.hide(),
            ...
            this.dayGrid &&
              (this.dayGrid.removeSegPopover(),
              (s = this.opt("eventLimit")) && "number" != typeof s && (s = Tn),
              s && this.dayGrid.limitRows(s)),
            e ||
              ((o = this.computeScrollerHeight(t)),
              this.scroller.setHeight(o),
              ((a = this.scroller.getScrollbarWidths()).left || a.right) &&
                (i(l, a),
                (o = this.computeScrollerHeight(t)),
                this.scroller.setHeight(o)),
  ...
  (Gt.agenda = {
    ...
    (Gt.agendaDay = { type: "agenda", duration: { days: 1 } }),
    (Gt.agendaWeek = { type: "agenda", duration: { weeks: 1 } });
  var Hn = (Vt.ListView = ze.extend({
    ...
    renderDates: function (t) {
      for (
        ...
        r.push(n.clone()),
          s.push(new Oe(n, n.clone().add(1, "day"))),
          n.add(1, "day");
    ...
    eventPointingClass: Ee.extend({
      handleClick: function (e, n) {
        var i;
        Ee.prototype.handleClick.apply(this, arguments),
